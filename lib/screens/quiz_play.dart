...
import 'package:elearning_applicaton/screens/quiz_play_widgets.dart';
import 'package:elearning_applicaton/screens/results.dart';
...
class _QuizPlayState extends State<QuizPlay> {
  ...
  void initState() {
    databaseService.getQuestionData(widget.quizId).then((value) {
      ...
      print("Number of documents: ${questionSnaphot.docs.length}");
      setState(() {});
  ...
  QuestionModel getQuestionModelFromDatasnapshot(
    ...
    List<String> options = [
      questionSnapshot["option1"].toString(),
      questionSnapshot["option2"].toString(),
      questionSnapshot["option3"].toString(),
      questionSnapshot["option4"].toString(),
    ];
    options.shuffle();
